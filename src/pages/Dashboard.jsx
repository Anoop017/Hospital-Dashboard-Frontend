...
import PatientsPerWeekChart from '../components/PatientsPerWeekChart';
    ...
    if (loading) {
      return (
        <div className="flex items-center justify-center min-h-screen">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-primary-600 cursor-pointer"></div>
        </div>
      );
    }
    ...
    return (
      <div className="space-y-8">
        ...
        {user?.role === 'admin' && (
          ...
          >
            {/* Total Users */}
            <motion.div whileHover={{ scale: 1.05 }} className="dashboard-card cursor-pointer">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {getRoleBasedQuickLinks().map((link, index) => (
              ...
              >
                <Link
                  to={link.to}
                  className="dashboard-card block hover:shadow-lg transition-all duration-200 cursor-pointer"
                >
                  <div className="flex items-center">
